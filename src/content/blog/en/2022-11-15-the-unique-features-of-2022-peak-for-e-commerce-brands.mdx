...
seo: {
  ...
  title: "",
  description: "The Unique Features of 2022 Peak For E-commerce Brands",
  keywords: ["key", "word"]
}
card: {
  image: {
    src: ./../../../images/blog/features2022.jpg,
    alt: "Desktop computer on a desk showing a website"
  }
}
...
**Start date:** 20th November <br/> **End date:** 18th December 
...
![Example of cash-based accounting record](./../../../images/blog/influencer.jpg)
