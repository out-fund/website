...
<div style="background: #F2F6FA; text-align:center; padding: 32px; border-radius: 10px; ">
  <h3 style="line-height: 1.2">Get in touch and discuss funding options <br/> for your Black Friday sales</h3>
  <Button href="https://blog--outfund.netlify.app/contact-us/" variant="primary">Contact us</Button>
</div>
