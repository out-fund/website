          ...
          <ContentWrapper>
            <SectionRegulated
              data={{
                ...
                description:
                  "El modelo es sencillo. Utilizando tus ingresos mensuales como guía, proporcionamos capital de crecimiento a cambio de un pequeño porcentaje de tus futuras ganancias. Tú nos devuelves el capital a través de un porcentaje preacordado de vuestros ingresos diarios, lo que significa que sólo tenemos éxito cuando la performance de la empresa es positivo. Si los ingresos disminuyen, también lo hacen los repagos.",
                blocks: [
                  {
                    title: "No dilutivo",
                    ...
                    text: "¿Para qué ceder equity para financiar aspectos repetibles de tu negocio como es el marketing digital? Es tu negocio. Mantén el control.",
                  },
                  {
                    ...
                    text: "Respira tranquilo, no pedimos garantías restrictivas. El acceso al capital nunca ha sido tan sencillo: no dejes que la obtención de financiación te impida escalar.",
                  },
                  {
                    title: "Sin intereses",
                    ...
                    text: "Una tarifa fija única, acordada de antemano. El coste del capital es siempre transparente y se reembolsa de forma equitativa con el porcentaje de ingresos acordado previamente.",
                  },
                ],
              }}
            />
