      ...
      <Main>
        <Wrapper>
          <ContentWrapper>
            <SectionRegulated
              data={{
                title: "Financiación basada en los ingresos",
                description:
                  "El modelo es muy sencillo. Utilizando tus ingresos mensuales como guía, proporcionamos capital de crecimiento a cambio de un pequeño porcentaje de tus futuros ingresos. Tú nos devuelves el capital a través de un porcentaje preacordado de vuestros ingresos diarios futuros, lo que significa que sólo tenemos éxito cuando el rendimiento de la empresa es positivo. Si los ingresos disminuyen, también lo hacen los repagos.",
                blocks: [
                  {
                    title: "No dilutivo",
                    ...
                    text: "¿Por qué ceder equity para financiar aspectos repetibles de tu negocio como es el marketing digital? Es tu negocio. Mantén el control.",
                  },
                  {
                    title: "Sin garantías personales",
                    ...
                    text: "No pedimos garantías personales. El acceso al capital nunca ha sido tan sencillo: no dejes que la obtención de financiación frene tu crecimiento.",
                  },
                  {
                    title: "Sin tipos de interés",
                    ...
                    text: "Una tarifa fija única, preacordada. El coste del capital es totalmente transparente y se reembolsa de forma equitativa con el porcentaje de ingresos acordado previamente.",
                  },
                ],
              }}
            />
