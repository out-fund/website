...
const ReferralProgram = (props) => {
  return (
    <LangLayout>
      <SeoComponent title="Adam Form" description="Adam Form" />
      <HeroSimple data={{ title: "Adam Form" }} />
      <Main>
        <Section>
          <Wrapper>
            <ContentWrapper>
              <TextWrapper>
                <SectionHeader
                  title={"Hey!"}
                  description={
                    "The fundraising World has gone a bit mad recently, I am sure you have been advised to batten down the hatches and extend your runway into 2025! Thats far. <br/> Due to this Outfund has just released a new “Runway Extension” product, aimed at helping see you through the impending recession.  <br/> Our Revenue Based Investment is non-dilutive and if you have a slow period coming up we don’t penalise you, as we only get repaid when you generate revenue! totally aligned with your journey. <br/> It would be great to have a chat to talk you through our runway options."
                  }
                />
              </TextWrapper>
