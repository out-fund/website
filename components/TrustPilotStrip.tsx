          ...
          >
            {props.reviews.map((review, index) => (
              <SwiperSlide
                ...
                key={index}
              >
                <a href={review.url} target="_blank" className="group block">
                  ...
                  <h6 className="text-md mb-1	line-clamp-2 h-[36px] w-[80%] font-semibold leading-[18px] group-hover:underline">
                    {review.title}
                  </h6>
                  ...
                  <div className=" mt-auto">
                    <div className="text-sm font-[500]">{review.name}</div>
